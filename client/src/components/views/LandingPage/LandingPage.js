...
function LandingPage() {
  ...
  const LazyMap = lazy(() => import("../../wheather/Map"));
  return (
    <>
      ...
      <LandingPageBlock>
        ...
        <Row gutter={[16, 16]}>
          <Col lg={12}>
            ...
            <CheckBox
              list={seasons}
              handleFilters={(filters) => handleFilters(filters, "seasons")}
            />
          </Col>
          <Col lg={12}>
            {/*RadioButton */}
        ...
        {/* Cards*/}
        <Row style={{ marginTop: "100px" }}>{renderCards}</Row>
        <br />
