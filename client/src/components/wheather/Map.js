        ...
        <GirdBar>
          <Row gutter={[16, 16]}>
            <Col lg={4} md={12} xs={12}>
              <GridBox>강수확률: {Math.round(dailyData.pop * 100)}%</GridBox>
            </Col>
            <Col lg={4} md={12} xs={12}>
              <GridBox>
            ...
            <Col lg={4} md={12} xs={12}>
              <GridBox>날씨: {weather.description}</GridBox>
            </Col>
            <Col lg={4} md={12} xs={12}>
              <GridBox>습도: {currentData.humidity}%</GridBox>
            </Col>
            <Col lg={4} md={12} xs={12}>
              <GridBox>바람: {currentData.wind_speed}m/s</GridBox>
            </Col>
            <Col lg={4} md={12} xs={12}>
              <GridBox>
                자외선: {currentData.uvi}{" "}
...
function Icon(props) {
  return <IconBlock image={props.image} />;
}
